...
func (rc *Cache) StartAndGC(config string) error {
	...
	if _, ok := cf["sentinelPassword"]; !ok {
		cf["sentinelPassword"] = ""
	}
	...
	rc.sentinelPassword = cf["sentinelPassword"]
...
func (rc *Cache) connectInit() {
	...
	if rc.sentinelPassword != "" {
		sentinelOptions = append(sentinelOptions, redis.DialPassword(rc.sentinelPassword))
	} else {
		if rc.password != "" {
			sentinelOptions = append(sentinelOptions, redis.DialPassword(rc.password))
		}
	}
	if rc.password != "" {
